...
count=np.arange(1,1000,5)
for k in count:
    names.append("ADABoost " + str(k))
    classifiers.append(AdaBoostClassifier(n_estimators=k))
...
my_df.to_csv('ADABoost.csv', index=False, header=False)