...
count=np.arange(0.5,101,0.5)
for k in count:
    names.append("SVM Poly " + str(k))
    classifiers.append(SVC(kernel="poly",gamma="auto", C=k, degree=3))
...
my_df.to_csv('SVM_poly.csv', index=False, header=False)