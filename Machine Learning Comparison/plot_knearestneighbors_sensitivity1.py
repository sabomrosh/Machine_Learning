...
"""
names = [" 1 Nearest Neighbors", "2 Nearest Neighbors", "3 Nearest Neighbors", "4 Nearest Neighbors",
         "5 Nearest Neighbors", "6 Nearest Neighbors", "7 Nearest Neighbors", "8 Nearest Neighbors",
         "9 Nearest Neighbors", "10 Nearest Neighbors", "15 Nearest Neighbors", "20 Nearest Neighbors",
...
for k in count:
    names.append("SVM Linear " + str(k))
    classifiers.append(SVC(kernel="linear", C=k),)
...
my_df.to_csv('SVMLinear.csv', index=False, header=False)