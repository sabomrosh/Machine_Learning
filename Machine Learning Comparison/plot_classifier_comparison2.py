...
classifiers = [
    ...
    GaussianProcessClassifier(1.0 * RBF(1.0), max_iter_predict=100,warm_start=True),###R
    DecisionTreeClassifier(max_depth=5),
    RandomForestClassifier(max_depth=50, n_estimators=1000, max_features=1),###R
    MLPClassifier(alpha=1),###R
